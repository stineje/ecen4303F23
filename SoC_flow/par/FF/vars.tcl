...
# Executed on 04:26:45 PM(Oct30) by user: jstine
...
global env
set env(VPATH) make
set vars(ff_exe_dir) "/home/jstine/Desktop/ecen4303F23/SoC_flow/par"
set vars(rundir) "/home/jstine/Desktop/ecen4303F23/SoC_flow/par"
...
set vars(cwd) {/home/jstine/Desktop/ecen4303F23/SoC_flow/par}
...
set vars(design_root) {/home/jstine/Desktop/ecen4303F23/SoC_flow/par/../..}
...
set vars(execute_string) {/usr/bin/tclsh /home/jstine/Desktop/ecen4303F23/SoC_flow/par/SCRIPTS/gen_flow.tcl -m flat -d FF -v 16.1.0 -s . -y none -n route}
...
set vars(pre_cts_sdc) {/home/jstine/Desktop/ecen4303F23/SoC_flow/synth/mapped/mult_pad.sdc}
...
set vars(script_path) {/home/jstine/Desktop/ecen4303F23/SoC_flow/par/SCRIPTS}
set vars(script_root) {/home/jstine/Desktop/ecen4303F23/SoC_flow/par/SCRIPTS}
set vars(seed) {1}
...
set vars(setup_func_mode,pre_cts_sdc) {/home/jstine/Desktop/ecen4303F23/SoC_flow/synth/mapped/mult_pad.sdc}
set vars(setup_path) {.}
...
set vars(tagged) {route,check_place,skip route,time_design,skip}
set vars(tdsp_core,pac_mode) {all}
set vars(threads) {1}
set vars(time_info_db) {RPT/time_info.db}
set vars(time_info_rpt) {RPT/time_info.rpt}
set vars(timelib) {}
set vars(timelib,max) {../osu_soc_3.0/lib/ami05/lib/osu05_stdcells.lib}
set vars(timelib,min) {../osu_soc_3.0/lib/ami05/lib/osu05_stdcells.lib}
set vars(top) {0}
set vars(top_cell) {mult_pad}
